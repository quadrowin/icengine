...
<body>
    ...
    <div class="main hero-unit green" style="height:360px; position:relative; background: linear-gradient(45deg, #020031 0%, #6D3353 100%) repeat scroll 0 0 transparent;
