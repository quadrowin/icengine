...
<body>
    ...
    <div class="main hero-unit green" style="height:390px; position:relative; background: linear-gradient(45deg, #020031 0%, #6D3353 100%) repeat scroll 0 0 transparent;
    box-shadow: 0 3px 7px rgba(0, 0, 0, 0.2) inset, 0 -3px 7px rgba(0, 0, 0, 0.2) inset; border-radius:0; margin:40px 0">
        ...
        <div style="left:50%; margin-left:-300px; position:absolute; z-index:10">{$content}</div>
    </div>
