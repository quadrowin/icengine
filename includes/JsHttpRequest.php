...
//        $f = fopen('/a', 'w'); fwrite($f, "{$text}\n{$this->_uniqHash}"); fclose($f);
        ...
        if ($this->LOADER != "xml") {
            ...
            if ($this->LOADER == "form")
            {
            	//document.JsHttpRequest_IFrameFlag
                //$js_http_request = 'top && top.JsHttpRequestGlobal && top.JsHttpRequestGlobal';
                $js_http_request = 'if (document.getElementById(\'jshr_div\') && document.getElementById(\'jshr_div\').JsHttpRequestGlobal) var jshr = document.getElementById(\'jshr_div\').JsHttpRequestGlobal; else var jshr = top.JsHttpRequestGlobal; jshr';
            }
            /* не реализовано в js
            elseif ($this->LOADER == "iframe")
            {
            	$js_http_request = 'document && document.JsHttpRequestGlobal && document.JsHttpRequestGlobal';
            }
            */
            else
            {
                $js_http_request = 'JsHttpRequest';
            }
