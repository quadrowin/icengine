...
class Model_Collection implements \ArrayAccess, \IteratorAggregate, \Countable
{
    ...
    /**
     *
     * @desc Ищет в коллекции эквивалентную по полям
	 * (если $fields пустой массив - по совпадению
     *  первичных ключей) заданой модель, и, если находит,
	 * то возвращает ее (из коллекции в которой ищется)
     * @param Model $item
     * @param array $fields
     * @return null|Model
     */
