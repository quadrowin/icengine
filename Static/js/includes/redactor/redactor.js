...
(function($){
    ...
    Redactor.prototype = {
        ...
        {
            if (s.content) {
                var button = $('<div title="' + s.title + '" class="redactor_btn_' + key + '">'+s.content+'</div>');
            } else {
                var button = $('<a href="javascript:void(null);" title="' + s.title + '" class="redactor_btn_' + key + '">'+s.content+'</a>');
            }
        ...
        resizeImage: function(resize)
        {
            ...
            var min_w = 100;
            var min_h = 10;
            var $redactorContainer = this.$el.closest('.redactor_box')
            ...
            $(resize).mousedown(function(e)
            {
                ...
                ratio = !ratio ? $(resize).width()/$(resize).height() : ratio;
            ...
            $(resize).mousemove(function(e)
            {
                if (clicked)
                {
                    ...
                    if (new_w > $redactorContainer.innerWidth() - 40) {
                        new_w = $redactorContainer.innerWidth() - 40;
                        new_h = new_w / ratio;
                    }
                    if (new_w < min_w) {
                        new_w = min_w;
