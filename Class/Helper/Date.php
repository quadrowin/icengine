...
class Helper_Date
{
     ...
     * @return type
     */
    public static function datetime($string, $showYear = false, $format = 0, $showTime = false)
    {
        $year = strtok($string, "-");
        $month = strtok("-");
        $day = strtok("-");
...
# function str_to_timestamp
     ...
     * 
     */
    public static function timestampToSpecialStr($timestamp)
    {
        $delta_time = (time() - $timestamp) / (3600 * 24);
