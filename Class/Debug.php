...
class Debug
{
    ...
    public static function errorHandler($errno, $errstr, $errfile, $errline, $errcontext = array())
    {
        ...
        self::outputErrors(new \ErrorException($errstr, $errno, 1, $errfile, $errline), $errcontext);
        if (
        ...
        if (is_scalar($config)) {
            if (isset (self::$_configPresets [$config])) {
                ...
                if ($config == 'fb' && !function_exists('fb')) {
                    require __DIR__ . '/../includes/FirePHPCore/fb.php';
                }
    ...
    public static function shutdownHandler()
    {
        ...
        if ($e) {
            ...
            Debug::errorHandler($e['type'], $e['message'], $e['file'], $e['line'], array());
        }
    }

    private static function outputErrors(\Exception $exception, $errcontext = array())
    {
